...
# remains recoverable from disk). All-NaN markers (cohort-unmeasured — e.g. Basel:
...
# analysis object). Note: the full cohort is 1.24M cells across 723 images — graph
# construction and enrichment are the heaviest cells in this notebook.
...
_gif = marker_cycle_gif(
    ...
    titles=_titles, fps=2, out_path="figures/jacksonfischer2020_full_marker_cycle.gif",
)
